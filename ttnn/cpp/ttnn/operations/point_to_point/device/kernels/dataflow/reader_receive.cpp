...
void kernel_main() {
    ...
    FabricStreamSender<HeaderPolicy::Cb> ack(conn_arg_idx, sender_is_forward, packet_header_cb_id, alignment);
    ...
    ccl_wait_min(local_semaphore_ptr, 1);
    ...
    ccl_sem_reset(local_semaphore_ptr, 0);
}
