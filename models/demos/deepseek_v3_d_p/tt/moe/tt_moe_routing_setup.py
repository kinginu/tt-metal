    ...
    def __init__(
        ...
        Args:
            ...
            expert_dispatch_table: Mapping of expert IDs to chip IDs within each dispatch group.
                ...
                Shape: (num_dispatch_groups, num_routed_experts) or (num_dispatch_groups, num_routed_experts + 1), int32.
                The +1 variant includes a sentinel column (always -1) at index num_routed_experts,
                used to safely handle padded tokens whose expert indices are set to num_routed_experts.
