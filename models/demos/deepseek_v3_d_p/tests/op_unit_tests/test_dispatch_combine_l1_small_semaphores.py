...
def test_deepseek_prefill_l1_small_semaphores(mesh_device, device_params, ccl_op, use_l1_small, expect_tt_error):
    ...
    if not use_l1_small:
        with expect_tt_error("Out of Memory", reason="L1 fragmentation from persisted semaphores"):
            ttnn.from_torch(
