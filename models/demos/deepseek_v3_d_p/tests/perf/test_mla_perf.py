...
def test_kimi_mla_chunked_perf_galaxy():
    ...
    run_model_device_perf_test_with_merge(
        ...
        # TODO: calibrate on BH Galaxy (8x4, FABRIC_1D_RING) and pin the measured ns/iter here, mirroring
        # test_deepseek_v3_mla_perf_galaxy. Placeholder until a ground-truth run is captured.
        expected_device_perf_ns_per_iteration=0,
        subdir="deepseek_v3_mla",
