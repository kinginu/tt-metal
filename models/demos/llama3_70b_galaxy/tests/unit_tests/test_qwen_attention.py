...
_impl_file = "_qwen_attention_bh_impl.py" if _is_blackhole_galaxy() else "_qwen_attention_wh_impl.py"
_spec = importlib.util.spec_from_file_location(
    "qwen_attention_active_impl", os.path.join(os.path.dirname(__file__), _impl_file)
)
_impl = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(_impl)

test_qwen_attention_inference = _impl.test_qwen_attention_inference
